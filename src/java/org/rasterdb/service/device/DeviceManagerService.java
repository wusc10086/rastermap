...
public class DeviceManagerService {
        ...
        sqls.setCallback(new SqlCallback() {
            ...
            public Object invoke(Connection conn, ResultSet rs, Sql sql) throws SQLException {
                ...
                while (rs.next()) {
                    ...
                    device.setNum(rs.getString("Num"));
                    device.setDeviceName(rs.getString("DeviceName"));
                    device.setLatitude(rs.getBigDecimal("latitude"));
                    device.setLongitude(rs.getBigDecimal("longitude"));
                    device.setElevation(rs.getBigDecimal("elevation"));
    ...
    public void delete(EFDevice device) {
        dao2.delete(device);
    }
