...
<body style=" width:100%;">
    <div class="page-title-breadcrumb">
            <%--  <h4 style="text-align: center;">添加新用户</h4>  --%>
            <h5 class="title">添加新用户</h5>
    </div>
   <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="col-sm-10">
                <form id="form" class="form-horizontal" action="<c:url value='/userManager/addSave'/>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="passwd" class="form-control ${passwdError}" id="passwd" value="${obj.user.passwd}" placeholder="用户登录密码">
