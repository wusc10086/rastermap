var MAP_INFO = {
	curUrl: function() {
		...
		var index_1 = href.indexOf("/",9);
		var index_2 = href.indexOf("/",index_1 + 1);
		return href.substring(0, index_2);
	}
};
window.MAP_INFO = MAP_INFO;
window.MAP_INFO.mapUrl = MAP_INFO.curUrl() + "/tile/maptile/788865972/{z}/{x}/{y}";
//console.log(window.MAP_INFO.mapUrl);
    ...
    LeafletCoordSys.create = function (ecModel, api) {
        ...
        ecModel.eachComponent('leaflet', function (leafletModel) {
            ...
            if (!leafletModel.__leaflet) {
                ...
                //L.tileLayer('http://127.0.0.1:18080/map-offline-demo/mapTile/788865972/{z}/{x}/{y}', {
                //    attribution: '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
                //}).addTo(leaflet);
                
                L.tileLayer(window.MAP_INFO.mapUrl, {
                    attribution: '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
                }).addTo(leaflet);
