                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="input-group col-md-11" style="">
                           <table class="deviceIds-list">
                                <tr>
                                    <td>
                                        <select id="deviceIds" multiple="multiple">
                    ...
                    success: function (obj) {
                        ...
                        $.each(obj.data, function (i, data) {
                            ...
                            for (var i = 0; i < value.length; i++) {
                                ...
                                if (Math.abs(value[i].value)>maxvalue){maxvalue=Math.abs(value[i].value);}
                                d.push(time, value[i].value);
                                deviceData.data.push(d);
                            }
                            hcObj.push(deviceData);
                        });
                        hight(hcObj,title,type,maxvalue);
                        userList();
                    }
                });
            });
            function hight(hcObj,title,type,maxvalue) {
                $('#container').highcharts({
                    ...
                    gridLineWidth: 0,
                    max:maxvalue*1.2, // 定义Y轴 最大值 
                    min:-maxvalue*1.2, // 定义Y轴 最小值 
                    }, 
                    /*数据点设置*/
                        plotOptions: {
                            series: {
