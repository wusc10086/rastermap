...
<body style=" width:100%;">
       ...
       <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-6">
            <div class="col-sm-10">
                <form id="form" class="form-horizontal" action="<c:url value='/deviceManager/editSave'/>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 input-group">
                        <input name="num" class="form-control ${numError}" id="num" value="${obj.device.num}" placeholder="站号" readonly>
