...
<div class="row" id="pagerPane">
    <ul id="pager" class="pagination center-block">
        ...
        <a href="${doListUrl}" aria-label="Previous" data-pageNo="${startPageNumber - pageSize}" data-totalCount="${totalCount}">
        ...
        <a href="${doListUrl}" aria-label="Next" data-pageNo="${endPageNumber + 1}"  data-totalCount="${totalCount}">
