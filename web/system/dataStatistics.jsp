    ...
    <div class="container-fluid">
        ...
        <script type="text/javascript">
            $("#tablePane").on("click", "a", function (e) {
                var a = e.target;
                if (a && (a.tagName == "SPAN" || a.tagName == "span")) {
                    a = a.parentNode;
                }
                
                var disabled = $(a).attr("data-disabled");
                if (disabled) {
                    return;
                }
        ...
        <script type="text/javascript">
            ...
            $("#queryBtn").click(function () {
                ...
                $.ajax({
                    ...
                    data: {startTime: $("#startTime").val(), endTime: $("#endTime").val(),
                        dataType: $("#dataType").val(), deviceIds: device},
                    url: "<%=request.getContextPath()%>/efdata/getefdataCount",
                    dataType: "json",
                    processData: true,
                    ...
                    success: function (obj) {
                        ...
                        $.each(obj.data, function (i, n) {
                            var item = {};
                            item.name = n.deviceName;
                            item.data = [];
                            item.data.push(n.ratio);
                            hcSeries.push(item);
                            
                        });
                       hight(hcSeries,title,type);
                       userList();
                    }
                });
            });
            function hight(hcSeries,title,type) {
