            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label for="userRealName" class="col-sm-3 control-label">用户名</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <c:url var="returnUrl" value="/system/index.jsp">
                                <c:param name="pager" value="${obj.pagerString}"/>
                            </c:url>
                            <a class="btn btn-default" href="${returnUrl}" role="button">返回功能页</a>
                    </div>
                    </div>
                    </form>
                </div>
