...
L.ImageOverlay.Rotated = L.ImageOverlay.extend({
	...
	onAdd: function (map) {
		...
		map.on('zoomend resetview moveend', this._reset, this);
...
//                map.getPanes().overlayPane.appendChild(this._image);
    ...
    onRemove: function(map) {
        map.off('zoomend resetview moveend', this._reset, this);
	...
	_reset: function () {
		...
		var scaleY = pxTopLeft.distanceTo(pxBottomLeft) / imgH * Math.cos(skewY);
                ...
                if(this._isIE9()){
                   this._rawImage.style.msTransformOrigin = '0 0';
                   this._rawImage.style.msTransform  =
